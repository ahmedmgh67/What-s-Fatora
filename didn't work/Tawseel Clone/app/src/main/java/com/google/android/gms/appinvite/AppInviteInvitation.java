...
{
  private static final String[] zzahe = { "jpg", "jpeg", "png" };
  ...
  private static Bundle zzT(Map<String, String> paramMap)
  {
  ...
  private static boolean zzcp(String paramString)
  {
    boolean bool2 = false;
    int i = 0;
    for (;;)
  ...
  public static final class IntentBuilder
  {
    ...
    public Intent build()
    {
      if (!TextUtils.isEmpty(this.zzahf))
      {
        ...
        {
          bool = true;
          zzac.zzb(bool, "Custom image must not be set when email html content is set.");
      ...
      while (TextUtils.isEmpty(this.zzahg)) {
        for (;;)
        {
          return this.mIntent;
          boolean bool = false;
    ...
    public IntentBuilder setAdditionalReferralParameters(Map<String, String> paramMap)
    {
      if (paramMap != null)
      {
        this.mIntent.putExtra("com.google.android.gms.appinvite.REFERRAL_PARAMETERS_URI", AppInviteInvitation.zzU(paramMap));
        return this;
      }
    ...
    public IntentBuilder setCustomImage(Uri paramUri)
    {
      boolean bool2 = false;
      zzac.zzw(paramUri);
      zzac.zzb(paramUri.isAbsolute(), "Image uri is not an absolute uri. Did you forget to add a scheme to the Uri?");
      ...
      if ((str2.equals("android.resource")) || (str2.equals("content")) || (str2.equals("file")))
      {
        ...
        bool1 = true;
        zzac.zzb(bool1, "Image uri must be a content URI with scheme \"android.resource\", \"content\" or \"file\", or a network url with scheme \"http\" or \"https\".");
        if (i == 0)
        {
      ...
      for (;;)
      {
        ...
        {
          bool1 = bool2;
          if (!AppInviteInvitation.zzcq(str1)) {}
        }
        else
        {
          bool1 = true;
        }
        zzac.zzb(bool1, String.valueOf(str1).concat(" images are not supported. Only jpg, jpeg, or png images are supported."));
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\google\android\gms\appinvite\AppInviteInvitation.class
