  ...
  extends Fragment
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramViewGroup = new View.OnClickListener()
    {
      ...
      {
        if (!PlaceAutocompleteFragment.zza(PlaceAutocompleteFragment.this)) {
          PlaceAutocompleteFragment.zzb(PlaceAutocompleteFragment.this);
        }
      }
    };
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\google\android\gms\location\places\ui\PlaceAutocompleteFragment.class
