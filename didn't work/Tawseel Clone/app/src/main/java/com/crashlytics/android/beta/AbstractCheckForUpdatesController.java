  ...
  implements UpdatesController
{
  ...
  private void performUpdateCheck()
  {
    ...
    String str2 = (String)this.idManager.getDeviceIdentifiers().get(IdManager.DeviceIdentifierType.FONT_TOKEN);
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\crashlytics\android\beta\AbstractCheckForUpdatesController.class
