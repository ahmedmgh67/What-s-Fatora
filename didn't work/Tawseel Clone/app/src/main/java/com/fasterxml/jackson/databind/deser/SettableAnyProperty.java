  ...
  implements Serializable
{
    ...
    throws IOException
  {
    ...
    throw new JsonMappingException(null, paramException.getMessage(), paramException);
  }
    ...
    throws IOException
  {
    try
    {
      this._setter.getAnnotated().invoke(paramObject1, new Object[] { paramString, paramObject2 });
      return;
    }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\deser\SettableAnyProperty.class
