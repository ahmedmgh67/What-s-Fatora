  ...
  implements ContextualSerializer
{
    ...
    throws JsonMappingException
  {
    ...
    {
      paramSerializerProvider = paramBeanProperty.findPropertyFormat(paramSerializerProvider.getConfig(), this._handledType);
      localObject = this;
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\ser\std\ArraySerializerBase.class
