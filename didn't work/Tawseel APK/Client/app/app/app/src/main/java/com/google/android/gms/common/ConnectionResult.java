  ...
  extends zza
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.zzauz == ((ConnectionResult)paramObject).zzauz) && (zzaa.equal(this.mPendingIntent, ((ConnectionResult)paramObject).mPendingIntent)) && (zzaa.equal(this.zzawY, ((ConnectionResult)paramObject).zzawY)));
    return false;
  }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\google\android\gms\common\ConnectionResult.class
