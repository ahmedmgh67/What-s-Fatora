...
class SessionProtobufHelper
{
  ...
  {
    int j = 0 + CodedOutputStream.computeBytesSize(1, ByteString.copyFromUtf8(paramTrimmedThrowableData.className));
    ...
    if (paramTrimmedThrowableData != null)
    {
      ...
      {
        paramInt1 = getEventAppExecutionExceptionSize(paramTrimmedThrowableData, paramInt1 + 1, paramInt2);
    ...
    throws Exception
  {
    ...
    {
      if (paramInt1 < paramInt2) {
        writeSessionEventAppExecutionException(paramCodedOutputStream, paramTrimmedThrowableData, paramInt1 + 1, paramInt2, 6);
      }
    }
    else {
      return;
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\crashlytics\android\core\SessionProtobufHelper.class
