  ...
  implements ContextualSerializer
{
    ...
    throws JsonMappingException
  {
    ...
    if (paramBeanProperty != null)
    {
      ...
      localObject4 = paramSerializerProvider.getAnnotationIntrospector();
      localObject1 = localValue;
      if (localObject2 != null)
      {
        localObject4 = ((AnnotationIntrospector)localObject4).findContentSerializer((Annotated)localObject2);
        localObject1 = localValue;
        if (localObject4 != null) {
          localObject1 = paramSerializerProvider.serializerInstance((Annotated)localObject2, localObject4);
        }
      }
      localValue = paramBeanProperty.findPropertyFormat(paramSerializerProvider.getConfig(), this._handledType);
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\ser\std\ObjectArraySerializer.class
