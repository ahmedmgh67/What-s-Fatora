  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    for (;;)
    {
      ...
      paramInt1 = 0;
      Object localObject;
      if (paramInt1 < this.mSpanCount)
      {
        localObject = this.mPrefetchDistances;
        if (this.mLayoutState.mItemDirection == -1) {}
        for (paramInt2 = this.mLayoutState.mStartLine - this.mSpans[paramInt1].getStartLine(this.mLayoutState.mStartLine);; paramInt2 = this.mSpans[paramInt1].getEndLine(this.mLayoutState.mEndLine) - this.mLayoutState.mEndLine)
        {
      ...
      paramInt1 = 0;
      while ((paramInt1 < this.mSpanCount) && (this.mLayoutState.hasMore(paramState)))
      {
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\v7\widget\StaggeredGridLayoutManager.class
