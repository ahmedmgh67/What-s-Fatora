  ...
  extends LinearLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label275:
    label346:
    for (paramInt1 = (int)(paramInt2 + (getChildAt(i).getPaddingTop() + 16.0F * getResources().getDisplayMetrics().density));; paramInt1 = paramInt2 + getPaddingBottom())
    {
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\v7\widget\ButtonBarLayout.class
