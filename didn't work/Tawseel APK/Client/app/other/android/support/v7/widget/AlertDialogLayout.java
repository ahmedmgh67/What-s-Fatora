  ...
  extends LinearLayoutCompat
{
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localObject1 != null)
    {
      ...
      j = ViewCompat.combineMeasuredStates(0, ViewCompat.getMeasuredState((View)localObject1));
    }
    i = 0;
    int i2 = 0;
    int m = j;
    ...
    if (localObject3 != null)
    {
      ...
      n = k + i;
      m = ViewCompat.combineMeasuredStates(j, ViewCompat.getMeasuredState((View)localObject3));
    }
    int i1 = 0;
    j = m;
    k = n;
    ...
    for (j = 0;; j = View.MeasureSpec.makeMeasureSpec(Math.max(0, i3 - n), i7))
    {
      ...
      if (localObject3 != null)
      {
        ...
        i = ViewCompat.combineMeasuredStates(j, ViewCompat.getMeasuredState((View)localObject3));
        i4 = m;
        m = i;
      }
      j = m;
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\v7\widget\AlertDialogLayout.class
