  ...
  private void recoverFocusFromState()
  {
    ...
    for (;;)
    {
      ...
      if (!isFocused())
      {
        ...
        if ((!this.mChildHelper.isHidden((View)localObject1)) && (((View)localObject1).getParent() == this) && (((View)localObject1).hasFocus())) {}
      }
      else
      {
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\v7\widget\RecyclerView.class
