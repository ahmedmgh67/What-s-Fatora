    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
      ...
      sendCommand("android.support.v4.media.session.command.GET_EXTRA_BINDER", null, new ResultReceiver(new Handler())
      {
        protected void onReceiveResult(int paramAnonymousInt, Bundle paramAnonymousBundle)
        {
          if (paramAnonymousBundle != null)
          {
            ...
            {
              paramAnonymousBundle = MediaControllerCompat.MediaControllerImplApi21.this.mPendingCallbacks.iterator();
              while (paramAnonymousBundle.hasNext())
              {
                ...
                MediaControllerCompat.MediaControllerImplApi21.this.mCallbackMap.put(localCallback, localExtraCallback);
                localCallback.mHasExtraCallback = true;
                try
                {
                  MediaControllerCompat.MediaControllerImplApi21.this.mExtraBinder.registerCallbackListener(localExtraCallback);
                }
    ...
    public final void registerCallback(MediaControllerCompat.Callback paramCallback, Handler paramHandler)
    {
      ...
      if (this.mExtraBinder != null)
      {
        ...
        this.mCallbackMap.put(paramCallback, paramHandler);
        paramCallback.mHasExtraCallback = true;
        try
        {
          this.mExtraBinder.registerCallbackListener(paramHandler);
          return;
        }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
