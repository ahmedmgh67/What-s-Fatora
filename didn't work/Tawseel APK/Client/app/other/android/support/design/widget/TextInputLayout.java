  ...
  protected void drawableStateChanged()
  {
    ...
    for (;;)
    {
      ...
      if (this.mCollapsingTextHelper != null) {
        bool1 = false | this.mCollapsingTextHelper.setState(arrayOfInt);
      }
      if (bool1) {
        invalidate();
      }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\design\widget\TextInputLayout.class
