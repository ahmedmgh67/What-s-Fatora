  ...
  public final void setPeekHeight(int paramInt)
  {
    ...
    for (i = 1;; i = 1)
    {
      do
      {
        ...
        return;
      } while ((!this.mPeekHeightAuto) && (this.mPeekHeight == paramInt));
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\design\widget\BottomSheetBehavior.class
