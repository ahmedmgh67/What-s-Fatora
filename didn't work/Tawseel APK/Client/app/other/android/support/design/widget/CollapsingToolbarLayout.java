  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    {
      ...
      if (this.mDrawCollapsingTitle)
      {
        ...
        label247:
        ((CollapsingTextHelper)localObject).setCollapsedBounds(n + j, i2 + (i1 + m), k + i3, this.mTmpRect.bottom + m - this.mToolbar.getTitleMarginBottom());
        localObject = this.mCollapsingTextHelper;
        if (i == 0) {
          break label440;
        }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\android\support\design\widget\CollapsingToolbarLayout.class
