...
class zzh
{
  ...
  public zzh(Context paramContext, String paramString)
  {
    ...
    this.zzbhD = paramContext.getSharedPreferences(paramString, 4);
  ...
  private String zzau(String paramString1, String paramString2)
  {
  ...
  private void zzeK(String paramString)
  {
    paramString = new File(zzw.getNoBackupFilesDir(this.zzqr), paramString);
  ...
  private void zzeL(String paramString)
  {
    SharedPreferences.Editor localEditor = this.zzbhD.edit();
    Iterator localIterator = this.zzbhD.getAll().keySet().iterator();
  ...
  public boolean isEmpty()
  {
    try
    {
      boolean bool = this.zzbhD.getAll().isEmpty();
      return bool;
    }
    finally
    {
  ...
  public void zza(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   9: invokestatic 188	com/google/firebase/iid/zzh$zza:zzc	(Ljava/lang/String;Ljava/lang/String;J)Ljava/lang/String;
    //   12: astore 4
    //   14: aload 4
    //   16: ifnonnull +6 -> 22
    //   19: aload_0
    ...
    //   21: return
    //   22: aload_0
    //   23: getfield 32	com/google/firebase/iid/zzh:zzbhD	Landroid/content/SharedPreferences;
    ...
    //   37: aload_2
    //   38: aload_3
    //   39: invokespecial 190	com/google/firebase/iid/zzh:zzp	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   42: aload 4
  ...
  /* Error */
  public KeyPair zzeM(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	com/google/firebase/iid/zzh:zzbhD	Landroid/content/SharedPreferences;
    //   6: aload_0
    //   7: aload_1
    //   8: ldc -52
    //   10: invokespecial 206	com/google/firebase/iid/zzh:zzau	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   13: aconst_null
    //   14: invokeinterface 209 3 0
    //   19: astore_2
    //   20: aload_0
    //   21: getfield 32	com/google/firebase/iid/zzh:zzbhD	Landroid/content/SharedPreferences;
    //   24: aload_0
    //   25: aload_1
    //   26: ldc -45
    //   28: invokespecial 206	com/google/firebase/iid/zzh:zzau	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   31: aconst_null
    ...
    //   147: pop
    //   148: aload_0
    //   149: getfield 24	com/google/firebase/iid/zzh:zzqr	Landroid/content/Context;
    //   152: aload_0
  ...
  void zzeN(String paramString)
  {
    try
    {
      zzeL(String.valueOf(paramString).concat("|"));
      return;
    }
    finally
    {
  ...
  public void zzeO(String paramString)
  {
    try
    {
      zzeL(String.valueOf(paramString).concat("|T|"));
      return;
    }
    finally
    {
  ...
  KeyPair zzjA(String paramString)
  {
    try
    {
      KeyPair localKeyPair = zza.zzGs();
      long l = System.currentTimeMillis();
      SharedPreferences.Editor localEditor = this.zzbhD.edit();
      localEditor.putString(zzau(paramString, "|P|"), FirebaseInstanceId.zzv(localKeyPair.getPublic().getEncoded()));
      localEditor.putString(zzau(paramString, "|K|"), FirebaseInstanceId.zzv(localKeyPair.getPrivate().getEncoded()));
      localEditor.putString(zzau(paramString, "cre"), Long.toString(l));
      localEditor.commit();
      return localKeyPair;
    }
    finally
  ...
  /* Error */
  public long zzjz(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   3: aload_1
    //   4: ldc_w 287
    //   7: invokespecial 206	com/google/firebase/iid/zzh:zzau	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   10: astore_1
    //   11: aload_0
    //   12: getfield 32	com/google/firebase/iid/zzh:zzbhD	Landroid/content/SharedPreferences;
    //   15: aload_1
    //   16: aconst_null
    ...
    //   24: ifnull +13 -> 37
    //   27: aload_1
    //   28: invokestatic 299	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   31: lstore_2
    //   32: aload_0
    //   33: monitorexit
    //   34: lload_2
  ...
  public zza zzq(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      paramString1 = zza.zzjB(this.zzbhD.getString(zzp(paramString1, paramString2, paramString3), null));
      return paramString1;
    }
    finally
    {
  ...
  static class zza
  {
    ...
    {
      this.zzbwP = paramString1;
      this.zzbhg = paramString2;
    ...
    static zza zzjB(String paramString)
    {
    ...
    boolean zzjC(String paramString)
    {
      return (System.currentTimeMillis() > this.timestamp + zzcjj) || (!paramString.equals(this.zzbhg));
    }
  }
}


/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\google\firebase\iid\zzh.class
