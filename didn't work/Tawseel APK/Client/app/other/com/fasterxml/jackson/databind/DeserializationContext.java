  ...
  implements Serializable
{
  ...
  {
    return InvalidFormatException.from(this._parser, String.format("Can not construct Map key of type %s from String (%s): %s", new Object[] { paramClass.getName(), _quotedString(paramString1), paramString2 }), paramString1, paramClass);
  }
  
  public JsonMappingException weirdNumberException(Number paramNumber, Class<?> paramClass, String paramString)
  {
    return InvalidFormatException.from(this._parser, String.format("Can not construct instance of %s from number value (%s): %s", new Object[] { paramClass.getName(), String.valueOf(paramNumber), paramString }), paramNumber, paramClass);
  }
  
  public JsonMappingException weirdStringException(String paramString1, Class<?> paramClass, String paramString2)
  {
    return InvalidFormatException.from(this._parser, String.format("Can not construct instance of %s from String value (%s): %s", new Object[] { paramClass.getName(), _quotedString(paramString1), paramString2 }), paramString1, paramClass);
  }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\DeserializationContext.class
