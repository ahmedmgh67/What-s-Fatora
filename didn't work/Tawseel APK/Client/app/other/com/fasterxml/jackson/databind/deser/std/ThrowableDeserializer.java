  ...
  extends BeanDeserializer
{
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      if ((!bool1) && (!bool2)) {
        throw JsonMappingException.from(paramJsonParser, "Can not deserialize Throwable of type " + this._beanType + " without having a default contructor, a single-String-arg constructor; or explicit @JsonCreator");
      }
      localObject2 = null;
      localObject1 = null;
      i = 0;
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\deser\std\ThrowableDeserializer.class
