  ...
  implements Serializable
{
  ...
  protected TypeDeserializerBase(JavaType paramJavaType, TypeIdResolver paramTypeIdResolver, String paramString, boolean paramBoolean, Class<?> paramClass)
  {
    ...
    paramTypeIdResolver = paramString;
    if (paramString == null) {
      paramTypeIdResolver = "";
    }
    this._typePropertyName = paramTypeIdResolver;
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\jsontype\impl\TypeDeserializerBase.class
