  ...
  extends DatabindContext
{
    ...
    throws JsonMappingException
  {
    ...
    {
      throw JsonMappingException.from(this, paramJavaType.getMessage(), paramJavaType);
    }
  }
    ...
    throws JsonMappingException
  {
    ...
    {
      throw JsonMappingException.from(this, paramClass.getMessage(), paramClass);
    }
  }
    ...
    throws IOException
  {
    ...
    throw JsonMappingException.from(this, "Incompatible types: declared root type (" + paramJavaType + ") vs " + paramObject.getClass().getName());
  }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\SerializerProvider.class
