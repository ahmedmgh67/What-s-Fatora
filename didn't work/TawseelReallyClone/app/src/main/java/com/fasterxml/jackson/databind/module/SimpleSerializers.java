  ...
  implements Serializable
{
  ...
  public JsonSerializer<?> findSerializer(SerializationConfig paramSerializationConfig, JavaType paramJavaType, BeanDescription paramBeanDescription)
  {
    ...
    {
      JsonSerializer localJsonSerializer = (JsonSerializer)this._classMappings.get(paramBeanDescription);
      ...
      for (paramJavaType = paramSerializationConfig; paramJavaType != null; paramJavaType = paramJavaType.getSuperclass())
      {
        ...
        localJsonSerializer = (JsonSerializer)this._classMappings.get(paramBeanDescription);
        if (localJsonSerializer != null) {
          return localJsonSerializer;
        }
      }
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\module\SimpleSerializers.class
