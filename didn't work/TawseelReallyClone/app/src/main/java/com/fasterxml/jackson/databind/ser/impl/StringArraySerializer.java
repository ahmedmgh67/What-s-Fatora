  ...
  implements ContextualSerializer
{
    ...
    throws JsonMappingException
  {
    ...
    {
      Object localObject4 = paramSerializerProvider.getAnnotationIntrospector();
      localObject3 = paramBeanProperty.getMember();
      localObject1 = localObject2;
      if (localObject3 != null)
      {
        localObject4 = ((AnnotationIntrospector)localObject4).findContentSerializer((Annotated)localObject3);
        localObject1 = localObject2;
        if (localObject4 != null) {
          localObject1 = paramSerializerProvider.serializerInstance((Annotated)localObject3, localObject4);
        }
      }
    }
    Object localObject3 = findFormatFeature(paramSerializerProvider, paramBeanProperty, String[].class, JsonFormat.Feature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED);
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\fasterxml\jackson\databind\ser\impl\StringArraySerializer.class
