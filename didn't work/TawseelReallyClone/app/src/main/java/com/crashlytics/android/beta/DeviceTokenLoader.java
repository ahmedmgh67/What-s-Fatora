  ...
  implements ValueLoader<String>
{
    ...
    throws Exception
  {
    ...
    for (;;)
    {
      try
      {
        paramContext = getZipInputStreamOfApkFrom(paramContext, "io.crash.air");
...
/* Location:              H:\As A Bussines Man\confedince\App Dev Department\What's Fatora\Tawseel APK\Client\dex2jar-2.0\t-dex2jar.jar!\com\crashlytics\android\beta\DeviceTokenLoader.class
