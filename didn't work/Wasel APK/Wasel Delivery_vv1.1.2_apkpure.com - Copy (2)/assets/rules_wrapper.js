...
function processEventForJourney(bkevent){
    ...
    $BK$.Journey.processEvent(bkevent,function(ruleId, ruleName, notification){
        if(engineListener){
            engineListener.onActionReceived(String(ruleId),String(ruleName), JSON.stringify(notification));
        }
    });
    $BK$.log("processing event... in JSEngine --");
}
...
function processEvent(bkevent){
    ...
    $BK$.processEvent(bkevent,function(ruleId, ruleName, notification){
        if(engineListener){
        ...
        notification = "undefined"
            ...
            engineListener.onActionReceived(String(ruleId),String(ruleName), notification);
